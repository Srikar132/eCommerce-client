...
const CartPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white overflow-x-hidden">
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-4 sm:py-6 overflow-x-hidden">
                {/* Header */}
                ...
                {isEmpty ? (
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-[1fr_min(360px,30%)] gap-6 xl:gap-8 overflow-x-hidden">
                        {/* Main Content */}
                        <div className="w-full min-w-0 overflow-x-hidden">
                            {/* Customs Notice */}
                            <div className="border-l-4 border-gray-500 pl-3 pt-4 pb-4 sm:pl-4 font-medium bg-zinc-100 mb-6 sm:mb-8 text-xs sm:text-sm text-gray-900 leading-relaxed wrap-break-word overflow-hidden">
                            ...
                            <div className="hidden xl:block py-6 border-b overflow-x-hidden">
                                <div className="flex justify-end items-start gap-4 sm:gap-8 lg:gap-16 xl:gap-24 flex-wrap">
