...
const DealCard = ({ image, href }: DealCardProps) => {
  return (
    <Link 
      href={href} 
      className="block w-full h-full group hover:scale-105 transition-transform duration-300 z-30 pointer-events-auto"
    >
    ...
    >
      <div className="deal-content h-screen relative flex items-center justify-center bg-secondary">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-between gap-20 lg:gap-[150px] pointer-events-none px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
          ...
          {/* Left Card */}
          <div className="deal-card-left bg-card w-[280px] sm:w-[320px] lg:w-[400px] aspect-[3/4] rounded-3xl shadow-2xl overflow-hidden flex flex-col z-10 will-change-transform">
            <DealCard image="/home/section7/left-1.webp" href="/products?sale=true" />
          </div>

          {/* Right Card */}
          <div className="deal-card-right bg-card w-[280px] sm:w-[320px] lg:w-[400px] aspect-[3/4] rounded-3xl shadow-2xl overflow-hidden flex flex-col z-10 will-change-transform">
            <DealCard image="/home/section7/right-1.webp" href="/products?sale=true" />
          </div>
        </div>
