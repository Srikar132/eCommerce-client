...
export default function ScrollingBanner() {
  return (
    <div className="w-full bg-[#F5F5C6] py-5 overflow-hidden border-y border-black/5 select-none">
              ...
              <div key={idx} className="flex items-center space-x-12">
                <span 
                  className={item.isBold 
                    ? "text-2xl md:text-3xl font-black tracking-tighter text-black" 
                    : "text-lg md:text-xl font-medium text-black/60"
                  }
                >
                  {item.text}
                </span>
