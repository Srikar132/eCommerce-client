                            ...
                            >
                                <div className="aspect-[21/9] relative bg-muted">
                                    ...
                                    <div className="absolute inset-0 bg-linear-to-r from-black/60 via-black/30 to-transparent flex flex-col justify-center px-10 sm:px-16 pointer-events-none">
                                        ...
                                        <div className="mt-4 inline-flex h-7 items-center rounded-full bg-background/20 backdrop-blur-md px-4 border border-white/30">
                                            <span
                                    ...
                                    <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0">
                                        <Button
                                            size="icon"
                                            variant="secondary"
                                            className="h-9 w-9 shadow-xl backdrop-blur-xl bg-background/10 hover:bg-background/30 text-white border border-white/20"
                                    ...
                                    <div className="absolute top-4 left-4">
                                        <Badge variant="secondary" className="bg-background/10 text-white border border-white/20 backdrop-blur-xl text-[10px] font-bold px-2.5 py-0.5 tracking-tighter">
