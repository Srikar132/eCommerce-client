...
export default function HomePremiumProductCard({
  ...
  return (
    <Card className={`w-full min-w-70 overflow-hidden rounded-3xl border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-background group ${className}`}>
