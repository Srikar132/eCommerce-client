...
export const queryKeys = {
  ...
  users: {
     ...
     */
    list: (params: UserParams) => ['users', params] as const,
  ...
  orders: {
     ...
     */
    list: (params: OrderParams) => ['orders', params] as const,
     ...
     * @param userId - User ID
     */
    userOrders: (userId: string, params?: { page?: number; size?: number }) => ['orders', 'user', userId, params] as const,
